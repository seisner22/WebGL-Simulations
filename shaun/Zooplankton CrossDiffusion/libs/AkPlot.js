...
class Plot{
    ...
    clickPosition(e){
        ...
        o.clickPx = (e.clientX + document.documentElement.scrollLeft - this.canvas.offsetLeft) ;
        o.clickPy = (e.clientY + document.documentElement.scrollTop - this.canvas.offsetTop) ;
